...
export class AllowanceException extends Error {
  constructor(public token: Token, public amount: BigNumberish, public spenderAddress: string) {
    super(`User must approve ${amount} of ${token.symbol} for ${spenderAddress} before withdrawing`);
  }
}
