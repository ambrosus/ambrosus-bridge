...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (isMainNet) {
    ...
    configFile.bridges.arbitrum.amb = deployResult.address;
    configFile.save()
  ...
  await setSideBridgeAddress(BRIDGE_NAME, configFile.bridges.arbitrum.side, hre)
