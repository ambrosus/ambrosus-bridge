...
python merge_abis.py AmbBridge.json EthBridge.json BSC_AmbBridge.json BSC_BscBridge.json | abigen --abi - --pkg=contracts --type=bridge --out=../internal/contracts/bridge.go
