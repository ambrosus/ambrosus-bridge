...
python merge_abis.py ETH_AmbBridge.json ETH_AmbBridge.json ETH_EthBridge.json BSC_AmbBridge.json BSC_BscBridge.json | abigen --abi - --pkg=bindings --type=bridge --out=../internal/bindings/bridge.go
