...
// CheckAura is a paid mutator transaction binding the contract method 0x7786c5c5.
//
// Solidity: function CheckAura_(((bytes,bytes,bytes,bytes32,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,int256)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],address,uint64)[]) auraProof, uint256 minSafetyBlocks) returns()
...
// SubmitTransfer is a paid mutator transaction binding the contract method 0xac21e077.
//
// Solidity: function submitTransfer(((bytes,bytes,bytes,bytes32,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,int256)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],address,uint64)[]) auraProof) returns()
