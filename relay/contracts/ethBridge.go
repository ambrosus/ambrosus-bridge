...
// SubmitTransfer is a paid mutator transaction binding the contract method 0x7119f210.
//
// Solidity: function submitTransfer(uint256 event_id, (bytes,bytes,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,bytes)[] blocks, (address,address,uint256)[] events, bytes[] proof, uint256 passedBlocks) returns()
func (_Eth *EthTransactor) SubmitTransfer(opts *bind.TransactOpts, event_id *big.Int, blocks []CheckPoABlockPoA, events []CommonStructsTransfer, proof [][]byte, passedBlocks *big.Int) (*types.Transaction, error) {
	return _Eth.contract.Transact(opts, "submitTransfer", event_id, blocks, events, proof, passedBlocks)
}

// SubmitTransfer is a paid mutator transaction binding the contract method 0x7119f210.
//
// Solidity: function submitTransfer(uint256 event_id, (bytes,bytes,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,bytes)[] blocks, (address,address,uint256)[] events, bytes[] proof, uint256 passedBlocks) returns()
func (_Eth *EthSession) SubmitTransfer(event_id *big.Int, blocks []CheckPoABlockPoA, events []CommonStructsTransfer, proof [][]byte, passedBlocks *big.Int) (*types.Transaction, error) {
	return _Eth.Contract.SubmitTransfer(&_Eth.TransactOpts, event_id, blocks, events, proof, passedBlocks)
}

// SubmitTransfer is a paid mutator transaction binding the contract method 0x7119f210.
//
// Solidity: function submitTransfer(uint256 event_id, (bytes,bytes,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,bytes)[] blocks, (address,address,uint256)[] events, bytes[] proof, uint256 passedBlocks) returns()
func (_Eth *EthTransactorSession) SubmitTransfer(event_id *big.Int, blocks []CheckPoABlockPoA, events []CommonStructsTransfer, proof [][]byte, passedBlocks *big.Int) (*types.Transaction, error) {
	return _Eth.Contract.SubmitTransfer(&_Eth.TransactOpts, event_id, blocks, events, proof, passedBlocks)
}
