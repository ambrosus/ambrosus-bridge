...
// SubmitTransferPoSA is a paid mutator transaction binding the contract method 0xbbfe2a21.
//
// Solidity: function submitTransferPoSA(((bytes,bytes,bytes32,bytes,bytes32,bytes,bytes,bytes,bytes,bytes,bytes,bytes)[],(bytes[],uint256,(address,address,uint256)[]),uint64) posaProof) returns()
...
//
// Solidity: event Withdraw(address indexed from, address tokenFrom, address tokenTo, uint256 eventId, uint256 feeAmount)
