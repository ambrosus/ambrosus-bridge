...
//
// Solidity: function queue(uint256 ) view returns(address tokenAddress, address toAddress, uint256 amount)
func (_Bridge *BridgeCaller) Queue(opts *bind.CallOpts, arg0 *big.Int) (struct {
	TokenAddress common.Address
	ToAddress    common.Address
	Amount       *big.Int
}, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "queue", arg0)
...
//
// Solidity: function queue(uint256 ) view returns(address tokenAddress, address toAddress, uint256 amount)
func (_Bridge *BridgeSession) Queue(arg0 *big.Int) (struct {
	TokenAddress common.Address
	ToAddress    common.Address
	Amount       *big.Int
}, error) {
	return _Bridge.Contract.Queue(&_Bridge.CallOpts, arg0)
}

// Queue is a free data retrieval call binding the contract method 0xddf0b009.
//
// Solidity: function queue(uint256 ) view returns(address tokenAddress, address toAddress, uint256 amount)
func (_Bridge *BridgeCallerSession) Queue(arg0 *big.Int) (struct {
	TokenAddress common.Address
	ToAddress    common.Address
	Amount       *big.Int
}, error) {
