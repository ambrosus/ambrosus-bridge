...
// CheckAura is a paid mutator transaction binding the contract method 0x367ef2cc.
//
// Solidity: function CheckAura_(((bytes3,bytes3,bytes32,bytes,bytes32,bytes,bytes,bytes,uint8,int64)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],address,int64)[]) auraProof, uint256 minSafetyBlocks, address sideBridgeAddress, address validatorSetAddress) returns()
...
// SubmitTransferAura is a paid mutator transaction binding the contract method 0x2a49cca9.
//
// Solidity: function submitTransferAura(((bytes3,bytes3,bytes32,bytes,bytes32,bytes,bytes,bytes,uint8,int64)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],address,int64)[]) auraProof) returns()
