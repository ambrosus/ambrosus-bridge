...
// todo name
func (b *Bridge) getBlocksAndEvents(transferEvent *contracts.CommonTransfer) (*contracts.CheckPoWPoWProof, error) {
...
func (b *Bridge) encodeTransferEvent(event *contracts.CommonTransfer) (*contracts.CommonStructsTransferProof, error) {
