...
// SubmitTransferAura is a paid mutator transaction binding the contract method 0xda15e11a.
//
// Solidity: function submitTransferAura(((bytes3,bytes3,bytes32,bytes,bytes32,bytes,bytes4,bytes,uint64)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],(address,int64)[],uint256)[],uint64) auraProof) returns()
...
// SubmitValidatorSetChangesAura is a paid mutator transaction binding the contract method 0xb26ee4f5.
//
// Solidity: function submitValidatorSetChangesAura(((bytes3,bytes3,bytes32,bytes,bytes32,bytes,bytes4,bytes,uint64)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],(address,int64)[],uint256)[],uint64) auraProof) returns()
