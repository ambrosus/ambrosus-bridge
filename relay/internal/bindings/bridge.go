...
// SubmitValidatorSetChangesAura is a paid mutator transaction binding the contract method 0xf0b0dd58.
//
// Solidity: function submitValidatorSetChangesAura(((bytes3,bytes3,bytes32,bytes,bytes32,bytes,bytes4,bytes,uint64)[],(bytes[],uint256,(address,address,uint256)[]),(bytes[],(address,int64)[])[],uint64) auraProof) returns()
