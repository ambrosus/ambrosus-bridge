...
type BridgeContract interface {
	...
	FilterRelayConfirmation(*bind.FilterOpts, []common.Address, []*big.Int) (*bindings.BridgeRelayConfirmationIterator, error)
	...
	GetRelays(*bind.CallOpts) ([]common.Address, error)
	...
	Initialize(*bind.TransactOpts, bindings.CommonStructsConstructorArgs, *big.Int, []common.Address) (*types.Transaction, error)
	...
	ParseRelayConfirmation(types.Log) (*bindings.BridgeRelayConfirmation, error)
	...
	WatchRelayConfirmation(*bind.WatchOpts, chan<- *bindings.BridgeRelayConfirmation, []common.Address, []*big.Int) (event.Subscription, error)
