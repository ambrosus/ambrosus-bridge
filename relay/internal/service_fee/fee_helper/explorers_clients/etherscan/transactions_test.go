...
func TestGetTxs(t *testing.T) {
	...
	r, err := explorer.TxListByFromToAddresses("0x295C2707319ad4BecA6b5bb4086617fD6F240CfE", "0x5570DF279dA47Fa46aBa4c1e27b55c8e1d6648A1", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGetTxsByFromList(t *testing.T) {
	...
	r, err := explorer.TxListByFromListToAddresses(fromList, "0x5570DF279dA47Fa46aBa4c1e27b55c8e1d6648A1", nil)
	if err != nil {
		t.Fatal(err)
	}
	fmt.Println(len(r))
